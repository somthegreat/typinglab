...
BEGIN
  ...
  IF v_date > CURRENT_DATE + INTERVAL '7 days' THEN
  ...
  v_index := (EXTRACT(DOY FROM v_date)::integer % array_length(v_texts, 1)) + 1;
  ...
  VALUES (v_date, v_text_content, v_target_wpm, v_target_accuracy, v_reward_points, 'standard')
