    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-md mx-auto">Create an account to save your typing statistics and view your improvement over time.</p>
          <Link to="/auth">
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="page-header">
          ...
          <p className="page-description">Track your typing progress over time</p>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {[
                ...
                { icon: Clock, label: 'Tests Completed', value: profile?.total_tests_completed || 0, color: 'text-muted-foreground' },
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="stat-card text-center">
                ...
                <div className="text-xl font-bold">{profile?.best_accuracy ? `${Number(profile.best_accuracy).toFixed(1)}%` : '--'}</div>
                <div className="text-xs text-muted-foreground">Best Accuracy</div>
              </div>
              <div className="stat-card text-center">
                <Award className="w-5 h-5 mx-auto mb-2 text-neon-yellow" />
            ...
            {chartData.length > 0 ? (
              <div className="space-y-6">
                <div className="glass-card p-6">
                  <h3 className="section-title">WPM Progress</h3>
                  <div className="h-64">
                ...
                <div className="glass-card p-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead>
                        <tr className="text-left text-muted-foreground text-xs font-medium uppercase tracking-wider border-b border-border">
                      ...
                      <tbody className="text-sm">
                        {testResults?.slice(0, 10).map((result) => (
                          <tr key={result.id} className="border-b border-border/50">
                            <td className="py-3 text-muted-foreground">{result.created_at ? format(new Date(result.created_at), 'MMM d, h:mm a') : '-'}</td>
              ...
              <div className="glass-card p-12 text-center">
                ...
                <p className="text-muted-foreground mb-6">Complete some typing tests to see your progress charts.</p>
                <Link to="/test">
